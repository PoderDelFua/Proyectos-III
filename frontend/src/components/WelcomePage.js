...
return (
    <div className="flex flex-col justify-between h-screen">
      ...
      <img src="/fondo-login.png" alt="Background" className="w-full h-48 object-cover" />
        ...
        <Link href="/welcome" className="bg-blue text-white px-12 py-4 rounded-lg font-semibold hover:bg-dark-blue transition duration-200 text-lg">
          Únete
        </Link>
  ...
  return (
      <div className="flex flex-col justify-between h-screen">
        ...
        <img src="/fondo-login.png" alt="Background" className="w-full h-48 object-cover" />
          ...
          <Link href="/signup" className="bg-blue text-white px-7 py-4 rounded-lg font-semibold hover:bg-dark-blue transition duration-200 text-lg">
            Regístrate
          </Link>
  
          <p className="mt-10">
            <Link href="/login" className="bg-light-blue text-blue px-4 py-4 rounded-lg font-semibold hover:bg-dark-blue hover:text-white transition duration-200 text-lg">
              Iniciar sesión
            </Link>
          </p>
