                ...
                <div className="w-full md:w-1/2 lg:w-2/5 z-10 p-4 md:p-8">
                    ...
                    <div className="bg-white shadow-xl rounded-lg p-6 custom-container-login">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-6">
                                <label htmlFor="nombre" className="block text-gray-800 font-bold">Nombre
                                    completo:</label>
                                <input onChange={(e) => setNombre(e.target.value)} type="text" name="nombre" id="nombre"
                                       placeholder="John Doe"
                                       className="w-full border border-gray-300 py-2 pl-3 rounded mt-2 outline-none focus:ring-indigo-600 :ring-indigo-600 custom-rectangulo"/>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <input onChange={(e) => setNickname(e.target.value)} type="text" name="nickname"
                                       id="nickname" placeholder="Tu apodo"
                                       className="w-full border border-gray-300 py-2 pl-3 rounded mt-2 outline-none focus:ring-indigo-600 :ring-indigo-600 custom-rectangulo"/>
                            </div>

                            <div className="mb-6">
                                <label htmlFor="correo" className="block text-gray-800 font-bold">Email:</label>
                                <input onChange={(e) => setCorreo(e.target.value)} type="email" name="correo"
                                       id="correo" placeholder="tucorreo@dominio.com"
                                       className="w-full border border-gray-300 py-2 pl-3 rounded mt-2 outline-none focus:ring-indigo-600 :ring-indigo-600 custom-rectangulo"/>
                            </div>
                            ...
                            <div className="mb-4">
                                <Link href="/login"
                                      className="text-sm font-thin-black text-gray-800 hover:underline inline-block hover:text-indigo-600">
                            ...
                            <div className="flex justify-center mb-8">
                                <button type="submit"
                                        className="cursor-pointer py-2 px-4 text-white font-bold w-1/2 rounded custom-cancel-button">
                                    Registrarse
                                </button>
                            </div>
                        </form>
